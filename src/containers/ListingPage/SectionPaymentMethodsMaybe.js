...
const SectionPaymentMethodsMaybe = props => {
  ...
  const selectedOptions = publicData && publicData.payments ? publicData.payments : [];
  return (
    <div className={css.sectionManufacturers}>
      <h2 className={css.manufacturersTitle}>
        <FormattedMessage id="EditListingPaymentMethodsPanel.title" />
      </h2>
      <hr></hr>
      <PaginatedList
...
export default SectionPaymentMethodsMaybe;
